...
SPEC: list[tuple[str, str, str, str]] = [
    ...
    ("ADP (last 7 days)", "adp_recent", "ADP from the last week of drafts only - catches injury news the full sample dilutes", "FPL Draft"),
    ("ADP move", "adp_move", "Recent ADP minus full-sample ADP. Negative = the market is taking him earlier than it was", "FPL Draft"),
    ("Times drafted (recent)", "times_drafted_recent", "Human drafts in the last 7 days. Low numbers make the recent ADP noisy", "FPL Draft"),
